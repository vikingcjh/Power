...
public class VideoLiveFragment extends BaseFragment implements VideoLiveContract.View{
    ...
    public void initPresenter() {
        if (mPresenter == null){
            VideoLiveModel model = new VideoLiveModel();
            mPresenter = new VideoLivePresenter(model,this);
        }
    }
    ...
    CameraCaptureSession.CaptureCallback mCaptureCallback = new CameraCaptureSession.CaptureCallback() {
        ...
        public void onCaptureStarted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, long timestamp, long frameNumber) {
            LogUtil.i("onCaptureStarted "+"01");
            super.onCaptureStarted(session, request, timestamp, frameNumber);
        }

        @Override
        public void onCaptureProgressed(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull CaptureResult partialResult) {
            LogUtil.i("onCaptureProgressed "+partialResult.getFrameNumber());
        ...
        public void onCaptureCompleted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull TotalCaptureResult result) {
            ...
            LogUtil.i("onCaptureCompleted "+result.getFrameNumber());
            List<CaptureResult.Key<?>> list = result.getKeys();
        ...
        public void onCaptureFailed(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull CaptureFailure failure) {
            LogUtil.i("onCaptureFailed "+"04");
            super.onCaptureFailed(session, request, failure);
        }

        @Override
        public void onCaptureSequenceCompleted(@NonNull CameraCaptureSession session, int sequenceId, long frameNumber) {
            LogUtil.i("onCaptureSequenceCompleted "+"05");
            super.onCaptureSequenceCompleted(session, sequenceId, frameNumber);
        }

        @Override
        public void onCaptureSequenceAborted(@NonNull CameraCaptureSession session, int sequenceId) {
            LogUtil.i("onCaptureSequenceAborted "+"06");
            super.onCaptureSequenceAborted(session, sequenceId);
        }

        @Override
        public void onCaptureBufferLost(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull Surface target, long frameNumber) {
            LogUtil.i("onCaptureBufferLost "+"07");
